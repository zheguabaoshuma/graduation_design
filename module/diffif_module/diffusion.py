...
class GaussianDiffusion(nn.Module):
    ...
    def p_losses(self, x_in, noise=None, clip_denoised=True):
        ...
        pred_noise = self.denoise_fn(torch.cat((x_start_vis, x_start_ir, x_noisy), dim=1),
        ...
        refine_x0 = self.refinement_fn(torch.cat([x_start_vis, x_start_ir], 1), pred_x0_detach,
                                       continuous_sqrt_alpha_cumprod)
